...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "<h3> $firstname, $middlename, $lastname, $phone, $email, $gender, $password, $confirm_password </h3>";
...
<main class=" m-5 ">
    ...
    <form method="post">
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                <label for="middle_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Middle Name(Optional)</label>
                <input type="text" name="middle_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Smith" />
            </div>
            <div>
